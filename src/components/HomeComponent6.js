    ...
    <div className="relative flex h-[95vh]  w-full ">
      ...
      <div className=" absolute w-full h-full  flex justify-end z-10">
        <div className="relative w-1/2 h-full">
          <motion.div
            ...
            className="absolute top-[10vh] left-[-50vh] h-[20vh] w-[20vh]  rounded-full"
          >
            <img
              src={Image4}
              alt="image 4"
              className=" h-full w-full object-cover border-8 rounded-full"
            />
          </motion.div>
          <motion.div
            animate={{ scale: 1.3 }}
            ...
            className="absolute top-[70vh] left-[-60vh] h-[20vh] w-[20vh] rounded-full"
          >
            <img
              src={Image4}
              alt="image 4"
          ...
          <motion.div
            ...
            className="absolute top-[60vh] left-[60vh] h-[20vh] w-[20vh]  rounded-full"
          >
            <img
              src={Image4}
              alt="image 4"
          ...
          <motion.div
            ...
            className="absolute top-[20vh] left-[5vh] h-[20vh] w-[20vh]  rounded-full"
          >
            <img
              src={Image4}
              alt="image 4"
          ...
          <img
            src={Image3}
            alt="image 4"
            className="absolute top-[20vh] left-[5vh] h-[20vh] w-[20vh] object-cover border-8 rounded-full"
          />
        </div>
      ...
      <div className="absolute top-0 left-0 h-full w-full bg-[#06070E]/90 z-30 flex ">
        ...
        <div className="relative h-full w-1/2 flex items-center justify-center  ">
          {data.map(({ name, tittle, text, image }) => (
            <Card3 tittle={tittle} name={name} text={text} image={image} />
          ))}
          <div className="absolute top-[72vh] left-[35vw] flex items-center justify-between w-1/4 p-4 z-50">
            <div className=" flex items-center justify-center h-[50px] w-[50px] bg-white rounded-full hover:cursor-pointer">
              --
            </div>
            <div className=" flex items-center justify-center h-[50px] w-[50px] bg-white rounded-full hover:cursor-pointer">
              --
